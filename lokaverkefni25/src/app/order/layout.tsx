...
export default function OrderLayout({
  ...
  return (
    <div className="overflow-visible h-full">
      <div className="flex flex-col pl-2 pr-2 min-h-screen md:flex-row gap-2 mx-auto  justify-start md:justify-center items-center md:items-start  w-full max-w-full md:max-w-[1200px] relative pt-10 ">
